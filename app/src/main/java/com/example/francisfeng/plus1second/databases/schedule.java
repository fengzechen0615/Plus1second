...
public class schedule {
    ...
    public void add(String date,String time,String course,String thing){
        ...
        db.execSQL("insert into schedule (date,time,course,thing) values(?,?,?,?)", new Object[]{
    ...
    public void update(String date,String time,String course,String thing){
        ...
        db.execSQL("update schedule set date = ?, course = ?, thing = ? where time = ?", new Object[]{
    ...
    public void delete(String time){
        SQLiteDatabase db = helper.getWritableDatabase();
        db.execSQL("delete from schedule where time =?", new Object[]{time});
        db.close();
    }
